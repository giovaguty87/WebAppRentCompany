...
namespace WebAppRentCompany.Controllers
{
    ...
    {
        private BGlobalEntities10 db = new BGlobalEntities10();
        ...
        public ActionResult Create([Bind(Include = "Id_insurance,Description")] Insurance insurance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_insurance,Description")] Insurance insurance)
        {
            if (ModelState.IsValid)
            {
